...
}**************** We already have text domain setup for the whole theme. Since wp-pagenavi is included into the theme there is no need for this.*/
...
function pagenavi_menu() {
    if (function_exists('add_options_page')) {
        add_options_page(__('PageNavi', 'eveningshade'), __('PageNavi', 'eveningshade'), 'manage_options', 'wp-pagenavi/pagenavi-options.php') ;
    }
}*/
...
function pagenavi_init_custom() {
    ...
    $pagenavi_options_custom['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','eveningshade');
    $pagenavi_options_custom['current_text'] = '%PAGE_NUMBER%';
    $pagenavi_options_custom['page_text'] = '%PAGE_NUMBER%';
    $pagenavi_options_custom['first_text'] = '&laquo; '. __('First','eveningshade');
    $pagenavi_options_custom['last_text'] = __('Last','eveningshade').' &raquo;';
